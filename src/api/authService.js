...
const url="https://todo-22.herokuapp.com"
...
const updateName=async(user,name)=>{
    ...
    const {data}= await axios.put(`${url}/api/user/updatename`,{name:name},config)
    return data
...
const updatePassword=async(user,password)=>{
    ...
    const {data}= await axios.put(`${url}/api/user/updatepassword`,{password:password},config)
    return data
}
